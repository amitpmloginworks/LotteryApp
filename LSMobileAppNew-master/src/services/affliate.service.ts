...
export class AffiliateServices {
    ...
    loadAffiliateData() {
        ...
        parameter.request.push({
            ...
            module_name: "get_affiliate_page_product_details",
        ...
        //let url = CommonService.apiUrl + "v2/affiliate_products/";
        let url = CommonService.REDIS_API_URL
    ...
    loadAffiliateTicketData() {
        ...
        parameter.request.push({
            ...
            website_id: "27",
            source_site: "mobi.lottosocial.com",
            module_name: "get_affiliate_page_ticket_number_details",
            customer_id: CommonService.session.customer_id,
            product_id: "36",
            offer_id: "1079"
        });
        ...
        console.log(CommonService.getHeaderForJWT());
        //let url = CommonService.apiUrl + "v2/affiliate_tickets/";
        let url = CommonService.REDIS_API_URL
        var response = this.http.post(url, parameter, opt).map(res => res.json());
