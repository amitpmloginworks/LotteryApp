...
import { NavController, IonicPage, NavParams, ViewController, ModalController, App, Platform, LoadingController } from 'ionic-angular';
...
export class ManageSyndicate2Page {
  ...
  viewRecent() {
    ...
    let modal = this.modalCtrl.create("RecentDrawPage")
    modal.present();
    modal.onDidDismiss(() => {
