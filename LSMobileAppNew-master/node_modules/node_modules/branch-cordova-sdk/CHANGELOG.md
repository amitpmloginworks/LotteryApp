...
## [v2.6.23](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/releases/tag/v2.6.23) (2018-01-23)

- **Completed Changes**
  - Merge pull request #435 from BranchMetrics/depsfix: updated dependencies ([6a34f](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/6a34f3e476a9ef895685936eef419f3624347c08))
  - fix: updated Android SDK to 2.16.0https://github.com/BranchMetrics/android-branch-deep-linking/blob/master/ChangeLog.md ([e3c38](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/e3c38768d0c29d72f7bcc75e080f9e159ba6769a))
  - chore: updated npm version to 2.6.24 ([8b540](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/8b54041e315c30dc0d9962af91687ace18d0a0e3))
  - fix: updated iOS SDK to 0.23.3https://github.com/BranchMetrics/ios-branch-deep-linking/releases ([b46ba](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/b46bac3906e0c72b3ed10c2ee15a7b3cc7f8056f))
  - Merge pull request #421 from BranchMetrics/app-prefixApp prefix ([75204](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/75204c062ff48cadd6dd1020cc6fa71c9508dc6e))

- **Closed Issues**
  - Unable to install branch-cordova-sdk following instructions ([#432](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/432))
  - Should routing work when using the URI scheme? ([#431](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/431))
  - Opening deeplink inapp ([#430](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/430))
  - Cannot find module 'xml2js' ([#429](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/429))
  - initSession + clicked_branch_link behaviour question ([#428](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/428))
  - Branch matrix shorten Url not fetch og:url facebook debug. ([#427](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/427))
  - Subscribe for events while the app is open ([#426](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/426))
  - Deeplink generated from app not fetch data for facebook post ([#425](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/425))
  - Cordova Branch Plugin seems to be changing apk release signing signature ([#424](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/424))
  - Error: BRANCH SDK: Cannot write file AndroidManifest.xml ([#422](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/422))
  - Error: BRANCH SDK: Invalid "android-prefix" in <branch-config> in your config.xml. ([#420](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/420))

## [v2.6.22](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/releases/tag/v2.6.22) (2018-01-09)

- **Completed Changes**
  - chore: updated npm version to 2.6.23 ([9b2ec](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/9b2ec7fcd2ba80c88c6be9a2cb1f29afff8bcf36))
  - fix: corrected validation for app prefix ([bc016](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/bc016377a064ef266b93db2b6efa0cc9b15fd144))
  - Merge pull request #417 from BranchMetrics/update-dependenciesUpdate dependencies ([5db19](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/5db19c8b58a7b863a7a3c657ffa4c9ef642cc0f4))

- **Closed Issues**
  - createBranchUniversalObject returns TypeError in Ionic ([#418](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/418))
  - Not compatible with Cordova Android 7.0.0 (SDK 2.6.21) ([#416](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/416))

## [v2.6.21](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/releases/tag/v2.6.21) (2017-12-12)

- **Completed Changes**
  - chore: updated Android SDK to 2.14.4https://github.com/BranchMetrics/android-branch-deep-linking/blob/master/ChangeLog.md ([c2ed8](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/c2ed8c4b66876ed0847fda0bbfabf1e5d8f1b0c6))
  - fix: correction for Android SDK 2.14.4 ([bae72](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/bae72de189b06b97a3b353e8e0612e3833786c1a))
  - fix: updated android-minSdkVersion for cordova 8.0.0 ([d3bfa](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/d3bfa3a9b4e46cf275d9f9592c3a5977fb6da330))
  - docs: removed trailing commas in examples ([10d40](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/10d40c3517ffdca3da327bfce2c9f88f0bd2a0ea))
  - chore: updated npm version to 2.6.22 ([74361](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/74361cd896998053e09be230aeb01a3c147fa1e3))
  - fix: removed custom dictionary from testbed example ([da69b](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/da69bfe88e5503dd6576bcb61b06396fa3bcc9fe))
  - docs: removed custom_dictionary from examplesThe native sdks can only support String key-value pairs. Custom dictionary key-value pairs must be created from the API instead. ([a48a7](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/a48a77083d5be1dd38907318505bd86b2e16c6ff))
  - chore: updated iOS SDK to 0.22.4https://github.com/BranchMetrics/ios-branch-deep-linking/blob/master/ChangeLog.md ([ca55e](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/ca55e11a4b07dea047ed1959cba26b12d1eceeb3))
  - chore: updated Android SDK to 2.14.3https://github.com/BranchMetrics/android-branch-deep-linking/blob/master/ChangeLog.md ([a2aa2](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/a2aa2288d98fcf9d0ccd558f38323d7541f6310c))
  - docs: removed response from initSession to remove confusion ([8820a](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/8820aafbcf79e66a6ec684e496779ebee6d7c1f2))
  - Merge pull request #407 from BranchMetrics/android-7-supportAndroid 7 support ([7b440](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/7b4409c76bd5540db16b44ff6f5fd28ca2b63b71))

- **Closed Issues**
  - Exception java.util.ConcurrentModificationException ([#415](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/415))
  - custom object in share link ([#414](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/414))
  - Cannot Install with Cordova 7.1.0 ([#413](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/413))
  - No data passed on resume ([#411](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/411))
  - inquiry:  will Branch functions properly for app released in non-US App/Play store? ([#410](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/410))
  - large [~id] number conversion in Branch.initSession(data =>..) ([#409](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/409))
  - "Trouble initializing Branch.  The request was invalid" on Android ([#408](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/408))
  - Branch deep link redirect to a page ([#406](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/406))
  - [Android@7.0.0] Branch install fails ([#405](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/405))

## [v2.6.20](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/releases/tag/v2.6.20) (2017-12-08)

- **Completed Changes**
  - chore: updated npm version to 2.6.21 ([d5a62](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/d5a62a36924e20a0e4ac517b69eaf7970d227b7d))
  - fix: added support for cordova android@7 ([28864](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/28864ab5739d5394d2808cb6b783c8a17935839f))
  - Merge pull request #404 from BranchMetrics/setRequestMetadataSet request metadata ([35c90](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/35c90eeaf5412c9e23bea647ee0e3a30b3af3fc3))

- **Closed Issues**
  - Cordova plugin cannot install when short name attribute used in config.xml for project ([#403](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/403))

## [v2.6.19](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/releases/tag/v2.6.19) (2017-12-07)

- **Completed Changes**
  - fix: added setRequestMetadata() example in testbed ([c8fe1](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/c8fe13e7525160f416e39bdc74396a7e5aedc6ea))
  - fix: added back backwards compatibility for setMixpanelToken() ([9f876](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/9f8763dca94ef06a5886f2ce5d684b582346e537))
  - fix: removed remote pull of sdk for local builds ([f24aa](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/f24aaf6fadddde6bffac7bfc1d569d1c9b3882dc))
  - chore: updated npm version to 2.6.20 ([5c6cc](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/5c6ccfc49d6b45c0da2a6a793baf1644704c516d))
  - fix: added setRequestMetadata() ([0d25b](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/0d25b1980182ce455ef55f93375a23d3f963f18a))
  - Merge pull request #400 from BranchMetrics/more-fixesMore fixes ([58021](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/5802163a6695b78ee750aa00715337de03448ab6))

- **Closed Issues**
  - branch.io not passing details after clicking link and installing app ([#402](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/402))
  - Inquiry:  cordova-deep-link-plugin and cordova-ionic-phonegap-branch-deep-linking ([#401](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/401))
  - Release 2.6.18 not mentioned in package.json ([#398](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/398))

## [v2.6.18](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/releases/tag/v2.6.18) (2017-11-10)

- **Completed Changes**
  - fix: corrected compiling error for latest iOS SDK ([03259](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/03259d0b04b95219eca640b92ef1a241c3ea979d))
  - fix: corrected cordova plugin add recursion for init ([de85c](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/de85c1243d0f90625c04f782ab546beaa8dd7277))
  - docs: separated update native sdk script for usability ([fe73a](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/fe73a46fe623a82b4cf6d05e1aa2f9a9717c9938))
  - fix: added short key support for bundle name ([b9051](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/b90519e1feecb35af484be27a676ed0a56f2cf7d))
  - fix: brought back npm dependencies ([d6c41](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/d6c41658c6ae71f3ce0fcffbc03cb6b6f4622dca))
  - chore: update iOS 0.21.13 ([0595d](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/0595dddb13f682ba4428038bbb125c8bd3f12a38))
  - fix: update native sdks now update plugin.xml ([9193f](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/9193ffac11a1c89c8f9bd1c6245fda6fbbf796f2))
  - fix: import testbed plugin from npm then override with local ([2d499](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/2d499461104cad83fa3d19781592df1b6110f754))
  - fix: removed autoVerify if target sdk < 23 on android ([b0e72](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/b0e72656354aff467a23d8192c9f3e1414ae26fb))
  - fix: corrected the child dependencies within the plugin project ([1fb30](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/1fb30a3bc2bf02865c7a7d92f48c98351c2a8c77))
  - fix: handled cordova 7.0.0 recursive plugin add ([cce33](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/cce33152a0a1b2f4a5361bbf85a4d08eb791b547))
  - fix: added logging to testbed init script ([03474](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/034745d7450dd1167964478daedee447d740e465))
  - fix: removed test harnesses ([683a7](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/683a711d381ebc54cd0b815c60b0bb24e3884f8c))
  - fix: updated ios 0.21.11changelog https://github.com/BranchMetrics/ios-branch-deep-linking/blob/master/ChangeLog.md ([4dc44](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/4dc44b61dfbd212ee408b4ec1d0b922ad48c6652))
  - chore: updated npm version to 2.6.19 ([a0c31](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/a0c316da3af6aeb5e6ff240f2d7558291827e9d5))
  - fix: updated android 2.14.1https://github.com/BranchMetrics/android-branch-deep-linking/blob/master/ChangeLog.md ([24a23](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/24a2386bc87611b89f37899a57ea4311612950e4))
  - chore: updated changelog ([fe645](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/commit/fe6456742dfb88be3754a49cf5845a41259b55f4))
...
- **Closed Issues**
  ...
  - Custom URL Scheme Non-branch links fire multiple times ([#393](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/393))
  - Links not working from intercom messenger ([#392](https://github.com/BranchMetrics/cordova-ionic-phonegap-branch-deep-linking/issues/392))
