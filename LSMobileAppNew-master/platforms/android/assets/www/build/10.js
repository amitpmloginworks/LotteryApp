...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__edit_profile__ = __webpack_require__(829);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__edit_profile_details_edit_profile_details_module__ = __webpack_require__(732);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__edit_profile_email_edit_profile_email_module__ = __webpack_require__(733);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__edit_profile_password_edit_profile_password_module__ = __webpack_require__(734);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
EditProfilePageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__edit_profile_details_edit_profile_details_module__["EditProfileDetailsModule"],
            __WEBPACK_IMPORTED_MODULE_4__edit_profile_email_edit_profile_email_module__["EditProfileEmailModule"],
            __WEBPACK_IMPORTED_MODULE_5__edit_profile_password_edit_profile_password_module__["EditProfilePasswordModule"],
...
var EditProfilePage = (function () {
    function EditProfilePage(params, navCtrl, viewCtrl, events, srvAccount, appSound, loadingCtrl, navParams) {
        var _this = this;
        this.params = params;
        this.navCtrl = navCtrl;
        ...
        this.loadingCtrl = loadingCtrl;
        this.navParams = navParams;
        this.tab1Root = 'EditProfileDetails';
        this.tab2Root = 'EditProfileEmail';
        this.tab3Root = 'EditProfilePassword';
        this.dismissed = false;
        console.log("EditProfilePage");
        this.events.subscribe('closeMe', function (userEventData) {
    ...
    EditProfilePage.prototype.submitDetails = function (detailsForm) {
        var _this = this;
            ...
            if (success) {
                ...
                for (var i = success.length - 1; i >= 0; i--) {
                    if (success[i].get_customer_details) {
                        _this.accountData = success[i].get_customer_details.response;
                        _this.events.publish('edit-profile', _this.accountData);
                        break;
                    }
                }
    ...
    EditProfilePage.prototype.loadProfileData = function () {
        var _this = this;
        var loader = this.loadingCtrl.create({
            spinner: 'hide',
            content: "<img src=\"assets/vid/blue_bg.gif\" style=\"height:100px!important\">",
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"])("editTabs"),
    __metadata("design:type", __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["u" /* Tabs */])
], EditProfilePage.prototype, "homeTabs", void 0);
EditProfilePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-edit-profile',template:/*ion-inline-start:"C:\Users\Ashok Kumar\Downloads\LSMobileAppNew-master\LSMobileAppNew-master\src\pages\edit-profile\edit-profile.html"*/'<ion-tabs #editTabs preloadTabs="false" class="ios-header">\n  <ion-tab [root]="tab1Root" tabTitle="DETAILS" [rootParams]="{accountData:accountData}"></ion-tab>\n  <ion-tab [root]="tab2Root" tabTitle="EMAIL" [rootParams]="{accountData:accountData}"></ion-tab>\n  <ion-tab [root]="tab3Root" tabTitle="PASSWORD" [rootParams]="{accountData:accountData}"></ion-tab>\n</ion-tabs>'/*ion-inline-end:"C:\Users\Ashok Kumar\Downloads\LSMobileAppNew-master\LSMobileAppNew-master\src\pages\edit-profile\edit-profile.html"*/
    }),
