...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__store__ = __webpack_require__(849);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_ionic_pullup__ = __webpack_require__(801);
...
StorePageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_5_ionic_pullup__["b" /* IonPullupModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__store__["a" /* StorePage */]),
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_4__ionic_native_badge__["a" /* Badge */]], exports: [__WEBPACK_IMPORTED_MODULE_2__store__["a" /* StorePage */]]
    })
], StorePageModule);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ion_pullup__ = __webpack_require__(802);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ion_pullup_tab__ = __webpack_require__(803);
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ion_pullup_module__ = __webpack_require__(850);
...
IonPullUpComponent.ctorParameters = function () { return [
    { type: __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* Platform */], },
...
IonPullUpComponent.propDecorators = {
    ...
    'initialState': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"] },],
    'defaultBehavior': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"] },],
    'maxHeight': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Input"] },],
    'onExpand': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"] },],
    'onCollapse': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"] },],
    'onMinimize': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["Output"] },],
    'childFooter': [{ type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["ViewChild"], args: ['footer',] },],
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_in_app_browser__ = __webpack_require__(397);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_badge__ = __webpack_require__(780);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_storage__ = __webpack_require__(44);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_params__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__services_common_service__ = __webpack_require__(38);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__services_service_home__ = __webpack_require__(398);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_offer_service__ = __webpack_require__(400);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__providers_app_sound_app_sound__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10_ionic_pullup__ = __webpack_require__(801);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ng2_simple_timer__ = __webpack_require__(401);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_ng2_simple_timer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_11_ng2_simple_timer__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_jquery__ = __webpack_require__(790);
...
var StorePage = (function () {
    function StorePage(app, st, params, ref, srvHome, loadingCtrl, alertCtrl, platform, navCtrl, navParams, storage, badge, menuCtrl, srvOffer, iab, commonSrv, appSound, offerService, modalCtrlr, actionSheetCtrl) {
        var _this = this;
        this.app = app;
        this.st = st;
        this.params = params;
        ...
        this.siteUrl = __WEBPACK_IMPORTED_MODULE_6__services_common_service__["a" /* CommonService */].sitename;
        this.offersForYou = {
            card_title: "",
            offer_group: []
        };
        ...
        // -------------------   slider   -----------------------
        this.slide = __WEBPACK_IMPORTED_MODULE_12_jquery__('.slider-single');
        this.slideCurrent = -1;
        this.loadBlogs();
        this.waveShowing = true;
        storage.get('firstTimeLoad').then(function (firstTimeLoad) {
            _this.visitorId = firstTimeLoad;
        });
        this.footerState = __WEBPACK_IMPORTED_MODULE_10_ionic_pullup__["a" /* IonPullUpFooterState */].Collapsed;
        ...
        this.params.events.subscribe('home-data', function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].get_home_card) {
                    _this.homeCard = data[i].get_home_card.response;
                    if (_this.homeCard.game && _this.homeCard.game.game
                        && _this.homeCard.game.game.game_group) {
                        _this.gameGroup = _this.homeCard.game;
                        _this.testList.push(_this.gameGroup.priority);
                        _this.testList.sort();
                        _this.total_cards += _this.gameGroup.game.game_group.length;
                    }
                    if (_this.homeCard.invited_to_private_syndicate && _this.homeCard.invited_to_private_syndicate.invited_group) {
                        _this.invitedPsyndicate = _this.homeCard.invited_to_private_syndicate;
                        _this.testList.push(_this.invitedPsyndicate.priority);
                        _this.testList.sort();
                        _this.total_cards += _this.invitedPsyndicate.invited_group.length;
                    }
                    if (_this.homeCard.invite_friends_to_private_syndicate && _this.homeCard.invite_friends_to_private_syndicate.invite_friends_group) {
                        _this.inviteToPs = _this.homeCard.invite_friends_to_private_syndicate;
                        _this.testList.push(_this.inviteToPs.priority);
                        _this.testList.sort();
                        if (_this.inviteToPs)
                            _this.total_cards += _this.inviteToPs.invite_friends_group.length;
                    }
                    //Getting jackpot
                    if (_this.homeCard.jackpot && _this.homeCard.jackpot.jackpot_group) {
                        _this.homejackpots = _this.homeCard.jackpot;
                        _this.testList.push(_this.homejackpots.priority);
                        _this.testList.sort();
                        if (_this.homejackpots) {
                            _this.total_cards++;
                        }
                    }
                    if (_this.homeCard.offers_for_you) {
                        _this.offersForYou = _this.homeCard.offers_for_you;
                        _this.testList.push(_this.offersForYou.priority);
                        _this.testList.sort();
                        _this.st.newTimer('1sec', 1);
                        _this.subscribeTimer0();
                        _this.total_cards++;
                    ...
                    _this.accountDetails = data[i].get_account_details.response;
                    if (_this.accountDetails.bonus_credit) {
                        _this.creditPoints = parseInt(_this.accountDetails.bonus_credit.slice(1));
                    }
                    else {
                        _this.creditPoints = 0;
                    }
                    if (_this.accountDetails.reward_points) {
                        _this.rewardPoints = parseInt(_this.accountDetails.reward_points);
                    }
                    else {
                    ...
                    _this.params.setUnreadCount(_this.unreadCount);
                }
            ...
            console.log("home data", _this.homeMessage);
        });
        this.checkCardExists();
        this.inboxBellCount();
    }
    StorePage.prototype.lastCalling = function () {
        var _this = this;
        this.commonSrv.getCreditPoints().subscribe(function (data) {
            ...
            if (data) {
                if (data.response[0].get_balance_details) {
                    if (data.response[0].get_balance_details.response.bonus_credit) {
                        _this.bonus_creditAPI = data.response[0].get_balance_details.response.bonus_credit.slice(1);
                    }
                    else {
                        _this.bonus_creditAPI = 0;
                    }
                    _this.winning_balanceAPI = data.response[0].get_balance_details.response.winning_balance;
                    _this.reward_pointsAPI = data.response[0].get_balance_details.response.reward_points;
                }
                else {
                    _this.bonus_creditAPI = "";
                    _this.winning_balanceAPI = "";
                    _this.reward_pointsAPI = "";
                }
            }
            _this.waveShowing = false;
        });
    };
    StorePage.prototype.onPopUp = function () {
        var modal = this.modalCtrlr.create('OverlaypagePage');
    ...
    StorePage.prototype.loadBlogs = function () {
    };
    StorePage.prototype.ionViewWillEnter = function () {
        ...
        this.commonSrv.trackSegmentPage("Store", "StorePage").subscribe(function (data) {
            console.log("track segment called");
        }, function (err) {
        }, function () { });
    };
    StorePage.prototype.checkCardExists = function () {
    };
    StorePage.prototype.showPaymentOptions = function (offer) {
    };
    StorePage.prototype.goPaymentWebviewHomeoffer = function (offer, prosub_id) {
    };
    StorePage.prototype.goPaymentWebview = function (offer) {
    };
    StorePage.prototype.loadLink = function (url) {
    };
    StorePage.prototype.mgmPageOpen = function () {
        this.appSound.play('buttonClick');
        var modal = this.modalCtrlr.create('referFriend');
        modal.present();
    };
    StorePage.prototype.gameTargetLink = function (target) {
    };
    StorePage.prototype.gotoSignupInvited = function (invited) {
    };
    StorePage.prototype.showLottoSocial = function () {
    };
    StorePage.prototype.viewAllOffers = function () {
        this.appSound.play('buttonClick');
        this.params.goTab(4);
    };
    StorePage.prototype.handle = function (str) {
    ...
    StorePage.prototype.goHomePage = function () {
        this.appSound.play('buttonClick');
        this.params.goHomePage();
    };
    StorePage.prototype.slideInitial = function () {
        this.slide = __WEBPACK_IMPORTED_MODULE_12_jquery__('.slider-single');
    ...
    StorePage.prototype.slideRight = function () {
        ...
        this.slide.each(function () {
            var thisSlide = __WEBPACK_IMPORTED_MODULE_12_jquery__(this);
    ...
    StorePage.prototype.slideLeft = function () {
        if (this.slideCurrent > 0) {
            this.slideCurrent--;
        }
        else {
    ...
    StorePage.prototype.swipeLeft = function (ev) {
        this.slideRight();
    };
    StorePage.prototype.swipeRight = function (ev) {
        this.slideLeft();
    };
    StorePage.prototype._showLoader = function () {
        var loader = this.loadingCtrl.create({
            spinner: 'hide',
            content: "<img src=\"assets/vid/blue_bg.gif\" style=\"height:100px!important\">",
            duration: 5000
    ...
    StorePage.prototype.tip = function () {
        this.appSound.play('buttonClick');
    ...
    StorePage.prototype.delay = function (ms) {
        return new Promise(function (resolve) { return setTimeout(resolve, ms); });
    };
    StorePage.prototype.tip2 = function () {
        this.appSound.play('buttonClick');
    ...
    //pull up code here
    StorePage.prototype.footerExpanded = function () {
        this.appSound.play('buttonClick');
        this.showDown = true;
        var a = this.pullUp;
        this.count = 1;
    ...
    StorePage.prototype.footerCollapsed = function () {
        this.appSound.play('buttonClick');
        this.showDown = false;
        var a = this.pullUp;
        console.log('Footer collapsed!');
    };
    StorePage.prototype.getMaximumHeight = function () {
        return window.innerHeight / 1.1;
    };
    //countDown timer
    StorePage.prototype.subscribeTimer0 = function () {
        var _this = this;
        if (this.timer0Id) {
            ...
            this.timer0Id = this.st.subscribe('1sec', function () { return _this.timer0callback(_this.offersForYou.offer_group); });
            this.timer0button = 'Unsubscribe';
            console.log('timer 0 Subscribed.');
        }
        console.log(this.st.getSubscription());
    };
    StorePage.prototype.timer0callback = function (data) {
        var value = data[0].countdown;
        this.result = "";
    ...
    StorePage.prototype.clicked = function () {
        this.tip11 = false;
        this.tip22 = false;
    };
    StorePage.prototype.openModal = function (eventData) {
        var modal = this.modalCtrlr.create('EventBlogPage', { event: eventData });
        modal.present();
    };
    StorePage.prototype.buyCreditOffer = function (offerId, prosub_id, buttonText) {
        var _this = this;
        ...
        if (!this.customerToken) {
            ...
            loader_1.present().then(function () {
                _this.srvOffer.buyCurrentOfferOnHomeCard(offerId).subscribe(function (data) {
                    ...
                    if (token_exists > 0) {
                        ...
                        localStorage.setItem("buttonText", _this.offersForYou.offer_group[0].total_cost);
                        _this.userCards = data.response;
                        _this.paymentType = "homeOffer";
                        console.log("StorePage::showPaymentOptions() success", _this.userCards);
                        _this.confirmPayment.togglePopup();
                    }
                    else {
                        _this.goPaymentWebviewHomeoffer(offerId, prosub_id);
                    }
                }, function (err) {
                    _this.appSound.play('Error');
                    loader_1.dismiss();
    ...
    StorePage.prototype.showModalForcreditoffer = function () {
    };
    StorePage.prototype.mgmOpenPage = function () {
        this.appSound.play('buttonClick');
        this.navCtrl.push('referFriend');
    };
    StorePage.prototype.countSlider = function (ev) {
        this.appSound.play("cardFlip");
    ...
    StorePage.prototype.redirectToOfferPage = function () {
        this.appSound.play('buttonClick');
        var tabs = this.navCtrl.parent;
        tabs.select(4);
    };
    StorePage.prototype.openNotificationMenu = function () {
        this.appSound.play('menuClick');
        var menu1 = this.menuCtrl.getMenus();
        menu1[0].open();
    };
    StorePage.prototype.inboxBellCount = function () {
        var _this = this;
        this.unreadCount = this.params.unreadCount;
        this.params.events.subscribe('unread-count', function (count) {
            console.log('CusHeaderComponent::', count);
    ...
    StorePage.prototype.Invite = function (sid) {
    };
    StorePage.prototype.goToOffers = function () {
        this.params.goTab(4);
    };
    StorePage.prototype.goBlogElementClcik = function () {
        this.navCtrl.push("BlogElementPage", { homeBlog: this.homeBlog, millionerImage: this.millionerImage });
    };
    StorePage.prototype.ngOnDestroy = function () {
        this.ref.detach(); // try this
    };
    StorePage.prototype.moveToCashOfferPage = function (offer) {
    };
    return StorePage;
}());
__decorate([
    ...
    __metadata("design:type", Object)
], StorePage.prototype, "pullUp", void 0);
__decorate([
...
StorePage = __decorate([
    ...
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["c" /* App */],
        ...
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* MenuController */],
        __WEBPACK_IMPORTED_MODULE_8__services_offer_service__["a" /* OfferService */],
        __WEBPACK_IMPORTED_MODULE_2__ionic_native_in_app_browser__["a" /* InAppBrowser */],
        __WEBPACK_IMPORTED_MODULE_6__services_common_service__["a" /* CommonService */],
        __WEBPACK_IMPORTED_MODULE_9__providers_app_sound_app_sound__["a" /* AppSoundProvider */],
        __WEBPACK_IMPORTED_MODULE_8__services_offer_service__["a" /* OfferService */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["n" /* ModalController */],
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ion_pullup__ = __webpack_require__(802);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ion_pullup_tab__ = __webpack_require__(803);
...
IonPullupModule.decorators = [
    { type: __WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"], args: [{
                imports: [__WEBPACK_IMPORTED_MODULE_1__angular_common__["b" /* CommonModule */], __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* IonicModule */]],
                declarations: [
