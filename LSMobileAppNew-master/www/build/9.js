...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "NewSyndicatePageModule", function() { return NewSyndicatePageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__new_syndicate__ = __webpack_require__(838);
...
var NewSyndicatePageModule = (function () {
    function NewSyndicatePageModule() {
    }
    return NewSyndicatePageModule;
}());
NewSyndicatePageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__new_syndicate__["a" /* NewSyndicatePage */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__new_syndicate__["a" /* NewSyndicatePage */]),
        ],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__new_syndicate__["a" /* NewSyndicatePage */]
        ]
    })
], NewSyndicatePageModule);

//# sourceMappingURL=new-syndicate.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return NewSyndicatePage; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
...
var NewSyndicatePage = (function () {
    function NewSyndicatePage(navCtrl, platform, params, viewCtrl, appSound, navParams) {
        this.navCtrl = navCtrl;
        this.platform = platform;
        this.params = params;
        this.viewCtrl = viewCtrl;
    ...
    NewSyndicatePage.prototype.ngOnInit = function () {
        var _this = this;
    ...
    NewSyndicatePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad NewSyndicatePage');
    };
    NewSyndicatePage.prototype.ionViewWillEnter = function () {
        this.tabbarElement.style.display = 'none';
    };
    NewSyndicatePage.prototype.ionViewWillLeave = function () {
        this.tabbarElement.style.display = 'flex';
    };
    NewSyndicatePage.prototype.goPage = function (page) {
        this.appSound.play('buttonClick');
        this.navCtrl.push('AddSyndicatePage', { tab: page });
    };
    NewSyndicatePage.prototype.close = function () {
        var data = "foo";
    ...
    return NewSyndicatePage;
}());
NewSyndicatePage = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'page-new-syndicate',template:/*ion-inline-start:"C:\Users\Ashok Kumar\Downloads\LSMobileAppNew-master\LSMobileAppNew-master\src\pages\new-syndicate\new-syndicate.html"*/'<ion-header>\n  <ion-navbar hideBackButton="true">\n    <ion-icon class="icon" ios="ios-arrow-back" md="md-arrow-back" (click)="close()"></ion-icon>\n    <ion-title class="title">Get Started!</ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-row>\n    <ion-card>\n      <img src="assets/image/privateSyndicateBigImage.jpg" height="170px">\n      <img src="assets/icon/icon1.png" class="header-icon" >\n      <p class="header-text" >\n        Join a ready made syndicate! Get more chances for less. Simply select a package and be in the draws immediately.\n        <!-- <b>cheapest rates.</b> We will\n        <b>automatically</b> enter you into an existing syndicate and manage your winnings and payouts equally -->\n      </p>\n      <hr class="hrClass">\n      <p class="newSyndicate-main-text"  >Fast, relaible and convinient,\n        <br> so what are you waiting for? </p>\n      <button (click)="goPage(1)" class="btnJoin" btn ion-button color="primary">VIEW SYNDICATES</button>\n    </ion-card>\n  </ion-row>\n  <ion-row class="bottom-row-wrapper" >\n    <ion-card>\n      <h3 class="headerBottom" class="headerBottom">OR CREATE A SYNDICATE</h3>\n      <hr class="hrClass">\n      <p class="bottomContent">Play with all your friends.\n        <br>Setup your syndicate easily.\n        <br>No more chasing for money!</p>\n      <p class="createSynd">\n        <!-- <b (click)="goPage(0)">CREATE A SYNDICATE</b> -->\n        <button (click)="goPage(0)" class="btnJoin" btn ion-button color="primary">START</button>\n      </p>\n    </ion-card>\n  </ion-row>\n\n</ion-content>'/*ion-inline-end:"C:\Users\Ashok Kumar\Downloads\LSMobileAppNew-master\LSMobileAppNew-master\src\pages\new-syndicate\new-syndicate.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["p" /* NavController */],
        __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* Platform */],
...
//# sourceMappingURL=new-syndicate.js.map
