...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__refer_friend_page__ = __webpack_require__(845);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(782);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__ = __webpack_require__(798);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__services_referfriend_service__ = __webpack_require__(799);
...
var ReferFriendPageModule = (function () {
...
ReferFriendPageModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
        declarations: [
            __WEBPACK_IMPORTED_MODULE_2__refer_friend_page__["a" /* referFriend */],
        ],
        imports: [
            __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__refer_friend_page__["a" /* referFriend */]),
        ],
        providers: [__WEBPACK_IMPORTED_MODULE_4__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_5__services_referfriend_service__["a" /* ReferFriend */]],
        exports: [
            __WEBPACK_IMPORTED_MODULE_2__refer_friend_page__["a" /* referFriend */]
        ],
    })
...
//# sourceMappingURL=refer-friend-page.module.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ReferFriend; });
...
var ReferFriend = (function () {
    function ReferFriend(http, params, storage, platform, transfer, file) {
        this.http = http;
        this.params = params;
        this.storage = storage;
        this.platform = platform;
    ...
    Object.defineProperty(ReferFriend, "parameters", {
        get: function () {
    ...
    ReferFriend.prototype.referFriend = function (action, page_id, module_names) {
        if (action === void 0) { action = "post"; }
        if (page_id === void 0) { page_id = "15"; }
        if (module_names === void 0) { module_names = "get_refer_friend"; }
...
//# sourceMappingURL=referfriend.service.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__ionic_native_social_sharing__ = __webpack_require__(798);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_referfriend_service__ = __webpack_require__(799);
...
var referFriend = (function () {
    function referFriend(share, appSound, platform, loadingCtrl, referService) {
        this.share = share;
        this.appSound = appSound;
        this.platform = platform;
        this.loadingCtrl = loadingCtrl;
    ...
    //     }
    // }
    referFriend.prototype.shareNow = function () {
        this.appSound.play('buttonClick');
        if (this.platform.is('cordova')) {
            this.share.share("Hello this is message", "This is subject", "", "https://nima.lottosocial.com/").then(function () {
            }).catch(function (data) {
                alert(data);
            });
        }
    };
    referFriend.prototype.ionViewWillEnter = function () {
        var _this = this;
        var loader = this.loadingCtrl.create({
            spinner: 'hide',
            content: "<img src=\"assets/vid/blue_bg.gif\" style=\"height:100px!important\">",
        ...
        loader.present().then(function () {
            _this.referService.referFriend()
                .subscribe(function (responseData) {
                _this.referFriendData = responseData.response[0].get_refer_friend.response;
                _this.getReferfriendData = responseData.response[0].get_refer_friend.response.refer_friend_data[0];
                _this.referMsg = responseData.response[0].get_refer_friend.response.refer_friend_data[0].mgm_message;
                _this.sharedata = JSON.parse(_this.referMsg);
                _this.shareImage = responseData.response[0].get_refer_friend.response.refer_friend_data[0].mgm_image;
                _this.shareUrl = responseData.response[0].get_refer_friend.response.refer_friend_data[0].mgm_referurl;
                loader.dismiss();
            }, function (err) {
...
referFriend = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
        selector: 'refer-friend',template:/*ion-inline-start:"C:\Users\Ashok Kumar\Downloads\LSMobileAppNew-master\LSMobileAppNew-master\src\pages\refer-friend-page\refer-friend-page.html"*/'<ion-header>\n    <newArrow-Header title="Refer to friend" notification-count="5"></newArrow-Header>\n</ion-header>\n<ion-content>\n\n    <div text-center class="headding">\n        <img src="{{getReferfriendData?.mgm_image}}">\n        <div class="redrow" text-center>\n            {{getReferfriendData?.mgm_title}}\n        </div>\n    </div>\n\n    <div class="shareContent">\n        <p>{{getReferfriendData?.mgm_description}}</p>\n    </div>\n    <ion-item no-lines>\n        <button class="btn btn-shareNow" \n            (click)="shareNow()">\n            <ion-icon ios="ios-share-outline" md="ios-share-outline" class="share-icon" ></ion-icon>\n            <span class="btnShare-text" >SHARE NOW</span>\n        </button>\n    </ion-item>\n    <!-- <div class="social-share" text-center>\n        <span class="left" (click)="emailShare()">\n        <img src="assets/img/mail.svg" class="social-image">\n        <p class="social-share-name">Email</p>\n        </span>\n        <span class="left" (click)="twitterShare()">\n        <img src="assets/img/twitter.svg" class="social-image">\n        <p class="social-share-name">Twitter</p>\n        </span>\n        <span class="left" (click)="whatsappShare()">\n        <img src="assets/img/whatsapp.svg" class="social-image">\n        <p class="social-share-name">WhatsApp</p>\n        </span>\n        <span class="left" (click)="facebookShare()">\n        <img src="assets/img/facebook.svg" class="social-image" >\n        <p class="social-share-name">Facebook</p>\n        </span>\n    </div> -->\n\n    <div class="footer">\n        <p>To qualify the £5 credit, your friend must be register and verify their age.</p>\n    </div>\n\n</ion-content>'/*ion-inline-end:"C:\Users\Ashok Kumar\Downloads\LSMobileAppNew-master\LSMobileAppNew-master\src\pages\refer-friend-page\refer-friend-page.html"*/
    }),
    __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__ionic_native_social_sharing__["a" /* SocialSharing */], __WEBPACK_IMPORTED_MODULE_4__providers_app_sound_app_sound__["a" /* AppSoundProvider */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* Platform */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* LoadingController */], __WEBPACK_IMPORTED_MODULE_3__services_referfriend_service__["a" /* ReferFriend */]])
], referFriend);

//# sourceMappingURL=refer-friend-page.js.map
